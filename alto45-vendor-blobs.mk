...
PATH_FILES := vendor/tcl/alto45/proprietary
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/etc/firmware/alto45_junda_fw.img:system/etc/firmware/alto45_junda_fw.img \
    $(PATH_FILES)/etc/firmware/alto45_ofilm_fw.img:system/etc/firmware/alto45_ofilm_fw.img \
    $(PATH_FILES)/etc/firmware/alto45_truly_fw.img:system/etc/firmware/alto45_truly_fw.img \
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/etc/permissions/android.hardware.sensor.gyroscope.xml:system/etc/permissions/android.hardware.sensor.gyroscope.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/etc/wifi/WCNSS_hw_wlan_nv_alto45_l01_vb.bin:system/etc/wifi/WCNSS_hw_wlan_nv_alto45_l01_vb.bin \
    $(PATH_FILES)/etc/wifi/WCNSS_hw_wlan_nv_alto45_l02_vb.bin:system/etc/wifi/WCNSS_hw_wlan_nv_alto45_l02_vb.bin \
    $(PATH_FILES)/etc/wifi/WCNSS_hw_wlan_nv_alto45_l03_vb.bin:system/etc/wifi/WCNSS_hw_wlan_nv_alto45_l03_vb.bin \
    $(PATH_FILES)/etc/wifi/WCNSS_hw_wlan_nv_alto45_ul_VC.bin:system/etc/wifi/WCNSS_hw_wlan_nv_alto45_ul_VC.bin \
...
PRODUCT_COPY_FILES += \
    ...
    $(PATH_FILES)/etc/apns-conf.xml:system/etc/apns-conf.xml \
    $(PATH_FILES)/etc/DxHDCP.cfg:system/etc/DxHDCP.cfg \
    $(PATH_FILES)/etc/ethertypes:system/etc/ethertypes \
    $(PATH_FILES)/etc/ft-0x80-testparam.ini:system/etc/ft-0x80-testparam.ini \
    $(PATH_FILES)/etc/ftm_test_config:system/etc/ftm_test_config \
    $(PATH_FILES)/etc/init.qcom.audio.sh:system/etc/init.qcom.audio.sh \
    $(PATH_FILES)/etc/init.qcom.bt.sh:system/etc/init.qcom.bt.sh \
    $(PATH_FILES)/etc/init.qcom.fm.sh:system/etc/init.qcom.fm.sh \
    $(PATH_FILES)/etc/init.qcom.modem_links.sh:system/etc/init.qcom.modem_links.sh \
    $(PATH_FILES)/etc/init.qcom.post_boot.sh:system/etc/init.qcom.post_boot.sh \
    $(PATH_FILES)/etc/init.qcom.rootagent.sh:system/etc/init.qcom.rootagent.sh \
    $(PATH_FILES)/etc/init.qcom.uicc.sh:system/etc/init.qcom.uicc.sh \
    $(PATH_FILES)/etc/init.qcom.wifi.sh:system/etc/init.qcom.wifi.sh \
    $(PATH_FILES)/etc/init.tct.gpio_keys.sh:system/etc/init.tct.gpio_keys.sh \
    $(PATH_FILES)/etc/media_codecs.xml:system/etc/media_codecs.xml \
    $(PATH_FILES)/etc/media_profiles.xml:system/etc/media_profiles.xml \
    $(PATH_FILES)/etc/mixer_paths.xml:system/etc/mixer_paths.xml \
    $(PATH_FILES)/etc/mixer_paths_mtp.xml:system/etc/mixer_paths_mtp.xml \
    $(PATH_FILES)/etc/mixer_paths_qrd_skuh.xml:system/etc/mixer_paths_qrd_skuh.xml \
    $(PATH_FILES)/etc/mixer_paths_qrd_skuhf.xml:system/etc/mixer_paths_qrd_skuhf.xml \
    $(PATH_FILES)/etc/mixer_paths_qrd_skui.xml:system/etc/mixer_paths_qrd_skui.xml \
    $(PATH_FILES)/etc/mmi.cfg:system/etc/mmi.cfg \
    $(PATH_FILES)/etc/MMI_PCBA.cfg:system/etc/MMI_PCBA.cfg \
    $(PATH_FILES)/etc/sec_config:system/etc/sec_config \
    $(PATH_FILES)/etc/vold.fstab:system/etc/vold.fstab \
